...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/plugin-support.cpp.in")
  configure_file(src/plugin-support.cpp.in plugin-support.cpp @ONLY)
  add_library(plugin-support STATIC)
  target_sources(
    plugin-support
    PRIVATE plugin-support.cpp
    PUBLIC src/plugin-support.hpp)
